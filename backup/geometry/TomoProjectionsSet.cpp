...
const std::vector<Position2D> * TomoProjectionsSet::GetBottomLeftPositionsPtr() const
{
...
const std::vector<std::vector<float>> * TomoProjectionsSet::GetXPositionsPtr() const
{
    return &m_xPositions;
}
const std::vector<std::vector<float>> * TomoProjectionsSet::GetYPositionsPtr() const
{
    return &m_yPositions;
}
const std::vector<Position2D> * TomoProjectionsSet::GetProjectionPositionsPtr() const
{
    return &m_projectionPositions;
}
const std::vector<int> * TomoProjectionsSet::GetProjectionPixelsIndicesPtr() const
{
    return &m_projectionPixelsIndices;
}
const std::vector<PixelOnProjection> * TomoProjectionsSet::GetProjectionIndiceAndPixelsPtr() const
{
...
{
    bool out = true;
    out &= *p_tomoProjectionsSetA.GetBottomLeftPositionsPtr() == *p_tomoProjectionsSetA.GetBottomLeftPositionsPtr();
