...
public:
    ...
    const std::vector<float> * GetXPositionsPtr() const;
    const std::vector<float> * GetYPositionsPtr() const;
    const std::vector<float> * GetZPositionsPtr() const;

    const std::vector<Position3D> * GetGridPositionsPtr() const;
    const std::vector<int> * GetVoxelsIndicesPtr() const;
