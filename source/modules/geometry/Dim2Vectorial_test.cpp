...
void TestConstructorIntegralType()
{
    ...
    Dim2Vectorial<T> point( expectedX, expectedY );
...
void TestFromStringIntegralType()
{
    ...
    auto expectedX = Random<T>();
    auto expectedY = Random<T>();
    std::string stringValues = ToStdString<T>( expectedX ) + " " + ToStdString<T>( expectedY );
    auto pointOptional = Dim2Vectorial<T>::FromString( stringValues );
...
void TestComparison()
{
    ...
    Dim2Vectorial<T> point1( originalX, originalY );
    Dim2Vectorial<T> point2( originalX, originalY );
    ...
    Dim2Vectorial<T> point3( differentX, differentY );
...
void TestAddition()
{
    ...
    Dim2Vectorial<T> left( Random<T>(), Random<T>() );
    Dim2Vectorial<T> right( Random<T>(), Random<T>() );
    Dim2Vectorial<T> expectedSum( left.x + right.x, left.y + right.y );
...
void TestSubtraction()
{
    ...
    Dim2Vectorial<T> left( Random<T>(), Random<T>() );
    Dim2Vectorial<T> right( Random<T>(), Random<T>() );
    Dim2Vectorial<T> expectedSubtraction( left.x - right.x, left.y - right.y );
...
void TestMultiplicationByScalar()
{
    ...
    Dim2Vectorial<T> point( Random<T>(), Random<T>() );
    auto scalar = Random<T>();
    Dim2Vectorial<T> expectedMultiplication( scalar * point.x, scalar * point.y );
...
TEST( Dim2VectorialTest, FromStringIntFromFloatString )
{
