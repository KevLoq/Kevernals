...
enum class TomoGeometryErrorCode
{
    XraySourcesPositionParsingError = 1,
    DetectorPositionsParsingError,
    FulcrumParsingError,
    ReconstructionVolumeGeometryParsingError,
    ProjectionRoisParsingError,
    FileToParseError,
    QStringToPositionIn3DWorldConversionError,
    QStringToQuadrilateral2DConversionError,
    QStringToSize3DConversionError,
};
...
template<>
struct is_error_code_enum<TomoGeometryErrorCode> : public std::true_type
{
};
