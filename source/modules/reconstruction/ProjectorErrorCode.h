...
enum class ProjectorErrorCode
{
    InvalidGeometryError = 1,
    GeometryInconsistency,
    VolumeProblemForProjection,
    ProjectionsDataFileReadingProblem,
    RadonMatrixComputation,
    BadAlgorithm,
};
...
template<>
struct is_error_code_enum<ProjectorErrorCode> : public std::true_type
{
};
